...
- BUGFIX [code]: perform program termination only once
- IMPROVEMENT [code]: catch errors on JSON, RegExp and top-level parsing
- IMPROVEMENT [code]: improve typing of border side, options and sizes
...
- CLEANUP [code]: remove redundancy in key, terminal and border handling
